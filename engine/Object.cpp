...
bool ObjectNameTag::contains(const std::string& str) const {
...
void Object::setVelocity(const Vec3D &velocity) {
    _velocity = velocity;
}

void Object::addVelocity(const Vec3D &velocity) {
    _velocity = _velocity + velocity;
}

void Object::setAcceleration(const Vec3D &acceleration) {
