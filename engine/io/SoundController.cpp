...
void SoundController::load(const SoundTag &soundTag, const std::string& filename) {
...
void SoundController::play(const SoundTag &soundTag) {
    if (_instance == nullptr) {
        return;
    }
...
void SoundController::pause(const SoundTag &soundTag) {
    if (_instance == nullptr) {
        return;
    }
...
void SoundController::stop(const SoundTag &soundTag) {
    if (_instance == nullptr) {
        return;
    }
