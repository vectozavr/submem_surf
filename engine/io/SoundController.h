...
public:
    ...
    static void load(const SoundTag &soundTag, const std::string& filename);

    static void play(const SoundTag &soundTag);
    static void pause(const SoundTag &soundTag);
    static void stop(const SoundTag &soundTag);
